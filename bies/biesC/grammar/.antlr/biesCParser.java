...
public class biesCParser extends Parser {
	...
	public static final int
		...
		RULE_anonymousLetFunction = 4, RULE_letInExpr = 5, RULE_let = 6, RULE_in = 7, 
		RULE_ifElseExpr = 8, RULE_simpleConstInstr = 9, RULE_anonymousConstFunction = 10, 
		RULE_primarydata = 11, RULE_expr = 12, RULE_functionCall = 13, RULE_number = 14, 
		RULE_string = 15, RULE_array = 16, RULE_id = 17, RULE_if = 18, RULE_then = 19, 
		RULE_else = 20, RULE_arrayAccess = 21, RULE_predSymbols = 22;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "printInstr", "simpleLetInstr", "anonymousLetFunction", 
			"letInExpr", "let", "in", "ifElseExpr", "simpleConstInstr", "anonymousConstFunction", 
	...
	public final IfElseExprContext ifElseExpr() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_ifElseExpr);
		try {
	...
	public final SimpleConstInstrContext simpleConstInstr() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_simpleConstInstr);
		int _la;
		try {
	...
	public final AnonymousConstFunctionContext anonymousConstFunction() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_anonymousConstFunction);
		int _la;
		try {
			setState(276);
			_errHandler.sync(this);
	...
	public final PrimarydataContext primarydata() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_primarydata);
		try {
			setState(282);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class PredSymbolsExpr_LabelContext extends ExprContext {
		public PredSymbolsContext predSymbols() {
			return getRuleContext(PredSymbolsContext.class,0);
		}
		public PredSymbolsExpr_LabelContext(ExprContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 5:
				{
				_localctx = new PredSymbolsExpr_LabelContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(289);
				predSymbols();
	...
	public final PredSymbolsContext predSymbols() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_predSymbols);
		try {
			setState(457);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
