...
public class biesCParser extends Parser {
	...
	public static final int
		...
		RULE_string = 14, RULE_array = 15, RULE_id = 16, RULE_predSymbols = 17;
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 872286216L) != 0)) {
				{
				{
				setState(36);
				statement();
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 805208074L) != 0)) {
				{
				setState(352);
				_errHandler.sync(this);
	...
	public final PredSymbolsContext predSymbols() throws RecognitionException {
		...
		enterRule(_localctx, 34, RULE_predSymbols);
		try {
			setState(388);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
